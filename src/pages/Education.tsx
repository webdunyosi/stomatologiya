...
// YouTube videolari uchun ma'lumotlar bazasi (Barcha 6 ta video kiritildi)
const videos = [
  { title: "To'g'ri cho'tkalash texnikasi", duration: "3:45", youtubeId: "Iqn1G8Xfi8Y" },
  { title: "Tish ipidan to'g'ri foydalanish", duration: "0:58", youtubeId: "pxGE6shGVoE" },
  { title: "Ildiz kanalini tushunish", duration: "5:12", youtubeId: "enW4Rcp2YY0" },
  { title: "Tish implantlari haqida", duration: "4:20", youtubeId: "ThnotqrYBKY" },
  { title: "Milkning kasalliklarini oldini olish", duration: "3:55", youtubeId: "NRUeEJ0S8gE" },
  { title: "Bolaning birinchi stomatolog tashrifi", duration: "0:45", youtubeId: "UVDtDrwc6to" }
];
